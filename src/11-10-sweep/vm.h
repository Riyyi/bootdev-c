...
typedef struct VirtualMachine {
	// stack frames: my_stack_t frame_t
	my_stack_t *frames;

	// These are the rest of the objects: my_stack_t snek_object_t
	my_stack_t *objects;
} vm_t;

typedef struct StackFrame {
	my_stack_t *references;
} frame_t;
...
void trace_blacken_object(my_stack_t *gray_objects, snek_object_t *ref);
